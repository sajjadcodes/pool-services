...
<?php 
        ...
        $stripe = new \Stripe\StripeClient(
            'sk_test_NbkHxvTsikf528zGvhDlHTn000R58IRl46'
        );
        ...
        foreach($data as $key => $value ) {  
            if( $value['id'] == 'price_1J5FIEEdDOqkcorfZhJ1NkVG' OR  $value['id'] == 'price_1J5FHBEdDOqkcorf4pxVBDce' OR $value['id'] == 'price_1J5FFpEdDOqkcorf6AS8xGXN') {
                $plans[] =  $value;
            }     
            // $plan = $value->id;
            // echo '<pre>';
            ...
            <div class="panel-body">
                ...
                {!! Form::open(['url' => route('order-post'), 'data-parsley-validate', 'id' => 'payment-form']) !!}
                    ...
                    <!-- {!! Form::label('plane', 'Select Plan:') !!}
                        {!! Form::select('plane', ['price_1J5FIEEdDOqkcorfZhJ1NkVG' => 'Enterprise-Plan ($0.40)','price_1J5FFpEdDOqkcorf6AS8xGXN' => 'Startup-Plan ($49.50)'], null, [
                        'class'                       => 'form-control',
                        'required'                    => 'required',
